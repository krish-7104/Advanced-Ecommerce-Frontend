          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/products">
                <Button
                  size="lg"
                  className="rounded-2xl h-12 px-8 text-base transition-all duration-200"
                >
              ...
              <Button
                size="lg"
                variant="outline"
                className="rounded-2xl h-12 px-8 border-slate-200 text-slate-700 hover:bg-slate-50 transition-all duration-200"
                asChild
              >
